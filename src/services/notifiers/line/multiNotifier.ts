 ...
 */
export class LineMultiNotifier implements Notifier<string[], NonNullable<GetPlanOutput>> {
  ...
  async pushMessage(recipients: string[], message: NonNullable<GetPlanOutput>) {
